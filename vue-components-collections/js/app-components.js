const LibraryComponent = Vue.component('Library', {
    ...
    data() {
        ...
        //let thisLibrary = new LibraryCollection();
        // this.Library.addItem(new Book('Learning Vue', 120));
        // this.Library.addItem(new Book('Interaction Design', 200))
        // this.Library.addItem(new Movie('Princess Bride', 118))
        // this.Library.addItem(new Movie('Strange Brew', 92));
