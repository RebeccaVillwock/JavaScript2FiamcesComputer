const LibraryComponent = Vue.component('Library', {
    ...
    data() {
        return {
            library: [
                new LibraryItem(new Book('Learning Vue', 120)),
                new LibraryItem(new Book('Interaction Design', 200)),
                new LibraryItem(new Movie('Princess Bride', 118)),
                new LibraryItem(new Movie('Strange Brew', 92)),
...
const LibraryItemComponent = Vue.component('LibraryItem', {
    ...
    template: `
        <div class="card" :class="{'border-success': item.isAvailable(), 'border-warning': !item.isAvailable()}">
                <component :is="typeOfItem" :item="item.media" class="card-body"></component>
...
const MediaComponent = Vue.component('Media', {
   props: {
       item: {
           type: Object,
           required: true,
